...
class _FeaturedNewsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final imageUrl = item.imageAssetPath;
...
class _AlertInfoDemoData {
  ...
  static const institutionalFeed = <_AlertInfoItem>[
    _AlertInfoItem(
      ...
      severity: 'Important',
      category: 'Sécurité',
      imageAssetPath: 'https://images.unsplash.com/photo-1582139329536-e7284fece509?w=800',
      featured: true,
    ),
    _AlertInfoItem(
      ...
      severity: 'Info',
      category: 'Santé',
      imageAssetPath: 'https://images.unsplash.com/photo-1584515933487-779824d29309?w=800',
      featured: true,
    ),
    _AlertInfoItem(
      ...
      imageAssetPath: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=800',
    ),
  ];
}
